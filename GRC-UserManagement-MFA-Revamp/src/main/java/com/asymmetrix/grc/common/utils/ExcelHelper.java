...
public class ExcelHelper {
  ...
  public static final String GROUP_HEADER_NAME = "groupName";
  public static final String USER_ID_HEADER_NAME = "userId";
  public static final String USER_GRADE_HEADER_NAME = "grade";
  ...
  public static List<Map<String, Object>> getDetailsFromExcel(MultipartFile file,
      String sheetName) {
  ...
  private static List<Map<String, Object>> mapAndGetDetails(Iterator<Row> rows,
    ...
    rows.forEachRemaining(row -> {
      ...
      row.cellIterator().forEachRemaining(currentCell -> {
        excelDetailsMap.put(headerList.get(currentCell.getColumnIndex()),
            getCellValueAsString(currentCell));
      });
