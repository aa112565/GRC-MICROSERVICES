...
<br>
The final authority to close EWS alerts has closed <b>${alertDeliveredCount!'-'} alerts</b> for <b>${customersCount} customers</b> 
for the date of ${alertDate?date!'-'}. 
<br>
<br>
<table id="alertDeliveredToL2" border="1">
    <tr>        
        ...
        <th width="10%">Remarks by final Authority</th>
    </tr>
