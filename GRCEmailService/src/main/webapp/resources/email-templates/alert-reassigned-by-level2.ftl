...
<br>
As per the alert re-assignment request, <b>${alertDeliveredCount!'-'} EWS alerts</b> for <b>${customersCount} customers</b> for the date of has been 
re-assigned from <b>${reassignFromUserName!'-'} to ${reassignToUserName!'-'}</b>.
...
<br>
<br>
<table id="alertDeliveredToL2" border="1">
    <tr>
    ...
    <#list alertDelivered as alert>
        <tr>
            <td class="name">${alert.level2User?capitalize}</td>
            <td>${alert.level2UserName!'-'}</td>
