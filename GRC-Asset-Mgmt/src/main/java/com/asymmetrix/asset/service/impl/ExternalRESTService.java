...
import com.asymmetrix.asset.common.exception.AssetRestClientException;
...
public class ExternalRESTService {
	...
	@Loggable(action = AssetConstants.USR_MGMT_REST_CALL)
	public List<String> getLvl1BrncCodeFomUsrMgmt(String url, String tokenValue) {
		try {
			...
			throw new AssetRestClientException(USER_MGMT_ERROR + e);
		}
	}
