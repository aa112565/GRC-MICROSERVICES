...
public class QuestionnaireCategoryAssessmentReportDTO {
	...
	private String assessmentEvidenceType;
	...
	public String getAssessmentEvidenceType() {
		return assessmentEvidenceType;
	}

	public void setAssessmentEvidenceType(String assessmentEvidenceType) {
		this.assessmentEvidenceType = assessmentEvidenceType;
	}
