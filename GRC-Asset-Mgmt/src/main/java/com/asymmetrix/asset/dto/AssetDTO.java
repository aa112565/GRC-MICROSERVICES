...
public class AssetDTO {
	...
	public AssetDTO(long assetId, String assetType, String assetName, String assetDesc, String assetCode,
			String assetSerialNumber, String assetCategory, String LeasedDate, String LeaseEndingDate,
			String assetPurchaseDate, String glCode, String purchaseOrderNumber, String assetSupplierDetails,
			String manufacturerDetails, String warrantyTill, String assetIndustry, String assetClassification,
			String uploadImage, String assetPrimaryOwner, String assetSecurityOwner, String assetSecondaryOwner,
			String assetAllocatedTo, String assetPrimaryOwnerId, String assetSecurityOwnerId,
			String assetSecondaryOwnerId, String assetAllocatedToId, String createdBy, String modifiedBy,
			String activeFlag, String deleteFlag) {
		super();
	...
	public AssetDTO(String assetType, String assetName, String assetDesc, String assetCode, String assetSerialNumber,
			String assetCategory, String LeasedDate, String LeaseEndingDate, String assetPurchaseDate, String glCode,
			String purchaseOrderNumber, String assetSupplierDetails, String manufacturerDetails, String warrantyTill,
			String assetIndustry, String assetClassification, String uploadImage, String assetPrimaryOwner,
			String assetSecurityOwner, String assetSecondaryOwner, String assetAllocatedTo, String assetPrimaryOwnerId,
			String assetSecurityOwnerId, String assetSecondaryOwnerId, String assetAllocatedToId, String createdBy,
			String modifiedBy, String activeFlag, String deleteFlag) {
		super();
		this.assetType = assetType;
		this.assetName = assetName;
		this.assetDesc = assetDesc;
...
//	private MultipartFile[] files;	
	...
	public String toString() {
		return "AssetDTO [assetId=" + assetId + ", assetType=" + assetType + ", assetName=" + assetName + ", assetDesc="
				+ assetDesc + ", assetCode=" + assetCode + ", assetSerialNumber=" + assetSerialNumber
				+ ", assetCategory=" + assetCategory + ", LeasedDate=" + LeasedDate + ", LeaseEndingDate="
				+ LeaseEndingDate + ", assetPurchaseDate=" + assetPurchaseDate + ", glCode=" + glCode
				+ ", purchaseOrderNumber=" + purchaseOrderNumber + ", assetSupplierDetails=" + assetSupplierDetails
				+ ", manufacturerDetails=" + manufacturerDetails + ", warrantyTill=" + warrantyTill + ", assetIndustry="
				+ assetIndustry + ", assetClassification=" + assetClassification + ", uploadImage=" + uploadImage
				+ ", assetPrimaryOwner=" + assetPrimaryOwner + ", assetSecurityOwner=" + assetSecurityOwner
				+ ", assetSecondaryOwner=" + assetSecondaryOwner + ", assetAllocatedTo=" + assetAllocatedTo
