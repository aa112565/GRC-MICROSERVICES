...
import com.asymmetrix.grc.common.exception.ControlLibraryClientException;
...
public class ExternalRESTService {
	...
	@Loggable(action = ControlLibraryConstants.USR_MGMT_REST_CALL)
	public List<String> getLvl1BrncCodeFomUsrMgmt(String url, String tokenValue) {
		try {
			...
			throw new ControlLibraryClientException(USER_MGMT_ERROR + e);
		}
	}
