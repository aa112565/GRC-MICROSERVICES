...
import com.grc.threat.common.exception.ThreatLibraryClientException;
...
public class ExternalRESTService {
	...
	@Loggable(action = ThreatLibraryConstants.USR_MGMT_REST_CALL)
	public List<String> getLvl1BrncCodeFomUsrMgmt(String url, String tokenValue) {
		try {
			...
			throw new ThreatLibraryClientException(USER_MGMT_ERROR + e);
		}
	}
