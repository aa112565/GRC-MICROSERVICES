...
import com.asymmetrix.grc.common.exception.RiskRestClientException;
...
public class ExternalRESTService {
	...
	@Loggable(action = RiskConstants.USR_MGMT_REST_CALL)
	public List<String> getLvl1BrncCodeFomUsrMgmt(String url, String tokenValue) {
		try {
			...
			throw new RiskRestClientException(USER_MGMT_ERROR + e);
		}
	}
